...
@class QTHomeProgressView;

@protocol WMPregressViewDelegate <NSObject>
- (UIColor *)colorOfProgressView:(QTHomeProgressView *)progressView atProgress:(CGFloat)progress;
@end

@interface QTHomeProgressView : UIView
...
@property (nonatomic, weak) id<WMPregressViewDelegate> delegate;
